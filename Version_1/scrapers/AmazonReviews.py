...
# a-link-normal
link_to_search = "https://www.amazon.com/s?k="
search_for_split = search_for.strip().split(" ")
for s in search_for_split:
    link_to_search += (s + "+")

print(link_to_search)

links = [
    'https://www.amazon.com/SAMSUNG-Electronics-Samsung-DA29-00020B-Refrigerator/product-reviews/B004UB1O9Q/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber='
]
'''
links = [
...
df.to_csv('AmazonReviewsSamungRefrigeratorFilter.csv', index=False)
print('Fin.')
